...
#ifndef RECORDING_ANALYZER_SWIFT_H
#define RECORDING_ANALYZER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="recording_analyzer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class AVAudioPlayer;
SWIFT_CLASS("_TtC18recording_analyzer11AudioPlayer")
...
SWIFT_CLASS("_TtC18recording_analyzer13AudioRecorder")
@interface AudioRecorder : NSObject <AVAudioRecorderDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
...
SWIFT_CLASS("_TtC18recording_analyzer16DirectoryMonitor")
